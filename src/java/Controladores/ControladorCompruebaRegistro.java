 ...
 * @author Gabriel
 */
public class ControladorCompruebaRegistro extends HttpServlet {
 ...
 request.setCharacterEncoding("UTF-8");
        ...
        try{
            ...
            if(estadoEscrutinio.equals("cerrado")){
                ...
                response.sendRedirect("Vistas/VistaError.jsp?codigo=Ya no puedes darte de alta");
            }
            ...
            response.sendRedirect("Vistas/VistaError.jsp?codigo=Alta Incorrecta");
        }
    }
