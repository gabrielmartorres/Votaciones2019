 ...
 * @author addaw19
 */
public class ControladorObtenerPartidos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ArrayList ListadoPartido = new Operaciones().listarPartido(Conexion);
            
            HttpSession Session= request.getSession(true);
            Session.setAttribute("ListadoPartidos",ListadoPartido);
